...
// Returns the private 'App\Repository\VistorsRepository' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VistorsRepository.php';

return $this->privates['App\\Repository\\VistorsRepository'] = new \App\Repository\VistorsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
