...
// Returns the private 'App\Repository\InvoiceLogRepository' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InvoiceLogRepository.php';

return $this->privates['App\\Repository\\InvoiceLogRepository'] = new \App\Repository\InvoiceLogRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
