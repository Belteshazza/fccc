...
// Returns the private 'App\Repository\ParticipantsAllowedRepository' shared autowired service.
...
include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParticipantsAllowedRepository.php';

return $this->privates['App\\Repository\\ParticipantsAllowedRepository'] = new \App\Repository\ParticipantsAllowedRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
