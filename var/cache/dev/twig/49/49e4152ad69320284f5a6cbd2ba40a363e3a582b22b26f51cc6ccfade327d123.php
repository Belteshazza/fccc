...
class __TwigTemplate_226270c0c68b2e05654de4ac15364ea9ae8c564857e474e8901adcfac7c2083d extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card\">
        ...
        <div class=\"card-body\">
            ...
            <form action=\"";
        // line 31
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_update_password");
        yield "\" method=\"POST\">
...
{% block body %}
    ...
    <div class=\"card\">
        ...
        <div class=\"card-body\">
            ...
            <form action=\"{{ path('user_update_password') }}\" method=\"POST\">
...
{% endblock %}", "user/account.html.twig", "C:\\laragon\\www\\training\\templates\\user\\account.html.twig");
    }
}
