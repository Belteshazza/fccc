...
class __TwigTemplate_ccac795cce9f4034ae7f3cb0bc35f6ddb2e68ac3748319ec52113264f5120bb3 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container\">
        ...
        yield "</h1>
                <p class=\"font-xl\">";
        // line 13
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["status_text"]) || array_key_exists("status_text", $context) ? $context["status_text"] : (function () { throw new RuntimeError('Variable "status_text" does not exist.', 13, $this->source); })()), "html", null, true);
        yield ". Click here to <a href=\"javascript: window.history.go(-1)\">Go back</a></p>
        ...
        <div class=\"col-sm-8 margin_100  mx-auto\">
            ...
            <div class=\"font-xl\">
                ...
                <img src=\"{{ asset('assets/images/logo.png') }}\" class=\"mb-5\" style=\"max-width: 300px\">
                    <h1 class=\"font-xl-3 font-weight-100 font-red\">Error {{ status_code }}</h1>
                <p class=\"font-xl\">{{ status_text }}. Click here to <a href=\"javascript: window.history.go(-1)\">Go back</a></p>
...
{% endblock %}", "@Twig/Exception/error404.html.twig", "C:\\laragon\\www\\training\\templates\\bundles\\TwigBundle\\Exception\\error404.html.twig");
    }
}
