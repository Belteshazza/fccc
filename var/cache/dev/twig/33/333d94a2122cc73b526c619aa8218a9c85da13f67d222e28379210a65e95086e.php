...
class __TwigTemplate_44558ec54fc104ca413beb070ed3ec73e14350a124bc0aaacdf6fefddd8255f6 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"metrics\">
        ...
        // line 68
        yield (((0 !== CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 68, $this->source); })()), "fallbackLocales", [], "any", false, false, false, 68)), 1))) ? ("s") : (""));
        yield "</span>
        </div>
    </div>
...
";
    ...
    public function block_messages($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            // line 84
            yield "            ";
            if ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["message"], "state", [], "any", false, false, false, 84), Twig\Extension\CoreExtension::constant("Symfony\\Component\\Translation\\DataCollectorTranslator::MESSAGE_DEFINED")))) {
                // line 85
                yield "                ";
                ...
                // line 86
                yield "            ";
            } elseif ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["message"], "state", [], "any", false, false, false, 86), Twig\Extension\CoreExtension::constant("Symfony\\Component\\Translation\\DataCollectorTranslator::MESSAGE_MISSING")))) {
                // line 87
                yield "                ";
                ...
                // line 88
                yield "            ";
            } elseif ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["message"], "state", [], "any", false, false, false, 88), Twig\Extension\CoreExtension::constant("Symfony\\Component\\Translation\\DataCollectorTranslator::MESSAGE_EQUALS_FALLBACK")))) {
                // line 89
                yield "                ";
        ...
        <div class=\"sf-tabs\">
            <div class=\"tab ";
        // line 94
        yield (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 94, $this->source); })()), "countMissings", [], "any", false, false, false, 94), 0))) ? ("active") : (""));
        yield "\">
        ...
        yield "                </div>
            ...
            <div class=\"tab ";
        // line 135
        yield (((1 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 135, $this->source); })()), "countMissings", [], "any", false, false, false, 135), 0))) ? ("active") : (""));
        yield "\">
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                ...
                yield "
                    ";
                // line 195
                if ((1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["message"], "parameters", [], "any", false, false, false, 195)), 0))) {
                    // line 196
...
{% endmacro %}
", "@WebProfiler/Collector/translation.html.twig", "C:\\laragon\\www\\training\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\translation.html.twig");
    }
}
